public class BinaryTree {
    ...
    public BinaryTree(String[] Data, String treeInput) {
        ...
        String[] NodeLeftOutput = new String[normalizedN];
        String[] NodeRightOutput = new String[normalizedN];
        ...
        r = 2;
        if(NodeList[(normalizedN-1)/2].LeftOutput().equals("****") && NodeList[(normalizedN-1)/2].RightOutput().equals("****")) {
        ...
        r = 1;
        if(NodeList[(normalizedN-1)].LeftOutput().equals("****") && NodeList[(normalizedN-1)].RightOutput().equals("****")) {
            ...
            for(int j = (jStep-1)/2; (j < n)&&(l < n); j = j + jStep) {
                ...
                if(k%2 == 1) {
                    if(r == 2 && NodeList[l] == null) {
                        ...
                        if((NodeList[l].LeftOutput().equals("****")) && (NodeList[l].RightOutput().equals("****"))) {
                    ...
                    if((NodeList[j].LeftOutput().equals("****")) && (NodeList[j].RightOutput().equals("****"))) {
